...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // --- UPDATE LOGIN/REGISTER, LOGOUT AND MY PROFILE NAVIGATION ---
  /**
  ...
  // --- CREATE USERNAME NAVIGATION TO MY PROFILE ---
  /**
  ...
  if (window.location.pathname.endsWith('/requests')) {
    ...
    if (isSridValid) {
      ...
      function initPagination(activeWidgetId) {
         ...
         * @param {number|null} page - The page number associated with the button (null for navigation buttons).
         * @param {string} className - Optional CSS class for the button li element.
         */
